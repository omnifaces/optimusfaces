...
Here's how it looks like with default PrimeFaces UI and all. This example uses a `Person` entity with `Long id`, `String email`, `Gender gender` and `Instant dateOfBirth` fields.
